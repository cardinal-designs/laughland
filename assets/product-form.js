customElements.define('product-form', class ProductForm extends HTMLElement {
  ...
  setVariant() {
    ...
    simulateClick(this.querySelector(`input[value="${inputValue}"]`))
...
customElements.define('sticky-product-bar', class StickyProductBar extends HTMLElement {
  ...
  bindEvents() {
    ...
    this.onetime.addEventListener('click', function(e){
      simulateClick(document.querySelector(`product-form[data-product-id="${ this.productId}"] [data-label-onetime]`))
    }.bind(this))

    this.subsave.addEventListener('click', function(e){
      simulateClick(document.querySelector(`product-form[data-product-id="${ this.productId}"] [data-label-subsave]`))
    }.bind(this))

    this.atc.addEventListener('click', function(e){
      e.preventDefault();
      this.atc.setAttribute("disabled", "true")
      simulateClick(document.querySelector(`product-form[data-product-id="${ this.productId}"] button[type="submit"]`))
    }.bind(this))
  }
